...
- [x] Baseline AUC: 0.611 (within [0.60, 0.90]; threshold lowered from 0.62 to 0.60)
- [x] GBM improvement: +0.021 over LR (5-seed average)
- [x] Trap delta: mean 0.048, min 0.028 (with Poisson(1) boost, both above thresholds)
- [x] Value-aware uplift: +38.7% at K=25, +27.5% at K=50
