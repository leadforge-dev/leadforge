...
- [x] 6 new tests: default-90 unchanged, shorter window fewer conversions, 1-day window zero conversions, late conversions excluded, conversion_timestamp still set outside window, event counts unchanged by window; total 787 passing
