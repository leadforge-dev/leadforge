...
# ---------------------------------------------------------------------------
# Registry (lead-scoring catalog)
# ---------------------------------------------------------------------------
# Lifecycle (b2b_saas_ltv_v1) entity rows + their LIFECYCLE_ROW_TYPES registry
# now live in ``leadforge.schemes.lifecycle.entities`` (moved in LTV-Pg).
# ``AccountRow`` above is shared and reused by the lifecycle scheme.
