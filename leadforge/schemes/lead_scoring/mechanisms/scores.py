...
:class:`~leadforge.schemes.lead_scoring.mechanisms.hazards.ConversionHazard` and
:class:`~leadforge.schemes.lead_scoring.mechanisms.transitions.HazardTransition` to collapse
