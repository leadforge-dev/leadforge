...
bottom of this module; they are consumed by :mod:`leadforge.schemes.lead_scoring.structure.sampler`
to seed a concrete :class:`~leadforge.schemes.lead_scoring.structure.graph.WorldGraph`.
...
class MotifFamily:
    ...
    Attributes:
        ...
        optional_node_ids: IDs from *canonical_nodes* that may be dropped
            ...
            :mod:`leadforge.schemes.lead_scoring.structure.rewiring`).
    """
