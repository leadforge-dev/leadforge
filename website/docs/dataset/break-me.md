...
[issue templates](https://github.com/leadforge-dev/leadforge/tree/main/.github/ISSUE_TEMPLATE).
Accepted findings are logged in
[v2 decision log](/docs/dataset/v2-decision-log).
...
2. Pick the issue template that fits — leakage / contamination
   ...
   [`dataset_breakage_report.yml`](https://github.com/leadforge-dev/leadforge/blob/main/.github/ISSUE_TEMPLATE/dataset_breakage_report.yml);
...
4. Watch [v2 decision log](/docs/dataset/v2-decision-log) for the
